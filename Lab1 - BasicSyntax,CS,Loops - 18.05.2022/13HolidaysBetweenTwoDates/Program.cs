...
namespace _13HolidaysBetweenTwoDates
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //By using the Visual Studio debugger, place a breakpoint and find the lines
            //of code that produce incorrect or unexpected results.
            //You are given a program(existing source code) that aims to count the non-working
            //days between two dates in format day.month.year
